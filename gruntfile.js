...
module.exports = function(grunt) {
    ...
    // Load all required Grunt tasks - no need for 'grunt.registerNpmTask()'
    ...
    grunt.initConfig({
        ...
        bowercopy: {
            ...
            server: {
                options: {
                    destPrefix: '.tmp/<%= app.baseurl %>/vendor/reveal'
                },
                files: {
            ...
            dist: {
                options: {
                    destPrefix: '<%= app.dist %>/<%= app.baseurl %>/vendor/reveal'
                },
                files: {
                    'css/reveal.css': 'reveal.js/css/reveal.css',
                    'css/print': 'reveal.js/css/print',
